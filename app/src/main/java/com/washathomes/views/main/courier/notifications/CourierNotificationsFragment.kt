package com.washathomes.views.main.courier.notifications
...
import com.washathomes.databinding.FragmentCourierNotificationsBinding
...
@AndroidEntryPoint
class CourierNotificationsFragment : Fragment() {

    lateinit var binding: FragmentCourierNotificationsBinding
    ...
    override fun onCreateView(
        ...
        val layout = inflater.inflate(R.layout.fragment_courier_notifications, container, false)
        binding = FragmentCourierNotificationsBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun setNotificationsRV(){
        ...
        binding.notificationRecyclerview.layoutManager = LinearLayoutManager(courierMainActivity)
    }
