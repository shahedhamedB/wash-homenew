...
class CourierWalletFragment : Fragment() {
    ...
    private fun onClick(){
        binding.toolbarLayout.notifications.setOnClickListener { navController.navigate(CourierWalletFragmentDirections.actionCourierWalletFragmentToCourierNotificationsFragment()) }
        binding.toolbarLayout.toolbarLeftIcon.setOnClickListener { navController.navigate(CourierWalletFragmentDirections.actionCourierWalletFragmentToCourierNotificationsFragment()) }
        binding.toolbarLayout.toolbarNotifyBadge.setOnClickListener { navController.navigate(CourierWalletFragmentDirections.actionCourierWalletFragmentToCourierNotificationsFragment()) }
    }
