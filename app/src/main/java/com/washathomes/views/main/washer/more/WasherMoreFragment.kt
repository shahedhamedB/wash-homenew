...
class WasherMoreFragment : Fragment() {
    ...
    private fun onClick(){
        binding.toolbarLayout.notifications.setOnClickListener { navController.navigate(WasherMoreFragmentDirections.actionWasherMoreFragmentToWasherNotificationsFragment()) }
        binding.toolbarLayout.toolbarNotifyBadge.setOnClickListener { navController.navigate(WasherMoreFragmentDirections.actionWasherMoreFragmentToWasherNotificationsFragment()) }
        binding.toolbarLayout.toolbarLeftIcon.setOnClickListener { navController.navigate(WasherMoreFragmentDirections.actionWasherMoreFragmentToWasherNotificationsFragment()) }
