...
class PendingOrdersItemsAdapter(
    ...
    var pendingOrders: ArrayList<PendingOrderObj>
) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, @SuppressLint("RecyclerView") position: Int) {
        val activeOrder = pendingOrders[position]
        ...
        holder.itemView.setOnClickListener { courierHomeFragment.pendingOrderDetails(activeOrder) }
    }
