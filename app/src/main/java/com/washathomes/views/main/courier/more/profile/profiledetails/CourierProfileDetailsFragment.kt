package com.washathomes.views.main.courier.more.profile.profiledetails
...
import com.washathomes.databinding.FragmentCourierProfileDetailsBinding
...
@AndroidEntryPoint
class CourierProfileDetailsFragment : Fragment() {

    lateinit var binding: FragmentCourierProfileDetailsBinding
    ...
    private fun initViews(view: View){
        ...
        if (AppDefs.user.results!!.image!!.isNotEmpty()){
            Glide.with(courierMainActivity).load(AppDefs.user.results!!.image).into(binding.profileImage)
        }
    ...
    private fun onClick(){
        ...
        binding.layout.setOnClickListener { courierMainActivity.hideKeyboard() }
    ...
    private fun openDatePicker(){
        ...
        val dpd = DatePickerDialog(courierMainActivity, { view, year, monthOfYear, dayOfMonth ->
    ...
    private fun setSpinner() {
        ...
        val genderAdapter: ArrayAdapter<*> =
            ArrayAdapter<String?>(courierMainActivity, R.layout.gender_spinner_item, items)
...
//        Toast.makeText(courierMainActivity, ""+latitude+", "+longitude+", "+address, Toast.LENGTH_LONG).show()
            ...
            phone.isEmpty() -> {
                ...
                if (AppDefs.user.results!!.phone != phone){
                    if (phone.startsWith("00")){
                        ...
                        Toast.makeText(courierMainActivity, resources.getString(R.string.phone_number_format), Toast.LENGTH_SHORT).show()
                    }else{
                        checkPhone()
                    }
                }else{
            ...
            override fun onResponse(call: Call<BooleanResponse>, response: Response<BooleanResponse>) {
                ...
                if (response.isSuccessful){
                    if (response.body()!!.results){
                        ...
                        Toast.makeText(courierMainActivity, resources.getString(R.string.phone_exists), Toast.LENGTH_SHORT).show()
                    }
                }else{
                    Toast.makeText(courierMainActivity, resources.getString(R.string.phone_exists), Toast.LENGTH_SHORT).show()
                }
    ...
    private fun saveUserToSharedPreferences() {
        ...
        editor.apply()
        val registrationIntent = Intent(courierMainActivity, SplashActivity::class.java)
    ...
    private fun verifyPhonePopUp(){
        ...
        verify.setOnClickListener {
            ...
            if (code.isNotEmpty()){
                verifyCode(code)
                courierMainActivity.hideKeyboard()
                alertBuilder.dismiss()
            }
    ...
    private fun sendVerificationCodeToUser(phoneNumber: String) {
        val options = PhoneAuthOptions.newBuilder(mAuth)
            ...
            .setActivity(courierMainActivity) // Activity (for callback binding)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == Activity.RESULT_OK) {
            ...
            image = courierMainActivity.convertToBase64(imageBitmap)!!
