package com.washathomes.views.main.washee.more.orderhistory.adapters
...
import com.washathomes.apputils.modules.Order
import com.washathomes.R
import com.washathomes.views.main.washee.more.orderhistory.OrderHistoryFragment
...
class OrdersAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, @SuppressLint("RecyclerView") position: Int) {
        ...
        holder.orderDetails.setOnClickListener { orderHistoryFragment.navigateToDetails(order) }
    }
