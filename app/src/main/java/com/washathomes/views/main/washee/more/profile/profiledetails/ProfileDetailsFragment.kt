package com.washathomes.views.main.washee.more.profile.profiledetails
...
class ProfileDetailsFragment : Fragment() {
    ...
    private fun onClick(){
        ...
        binding.layout.setOnClickListener { washeeMainActivity.hideKeyboard() }
    ...
    private fun imagePickerPopUp() {
        ...
        camera.setOnClickListener {
            if (ContextCompat.checkSelfPermission(washeeMainActivity, Manifest.permission.CAMERA)
    ...
    private fun setSpinner() {
        ...
        val genderAdapter: ArrayAdapter<*> =
            ArrayAdapter<String?>(washeeMainActivity, R.layout.gender_spinner_item, items)
...
//        Toast.makeText(washeeMainActivity, ""+latitude+", "+longitude+", "+address, Toast.LENGTH_LONG).show()
            ...
            phone.isEmpty() -> {
                ...
                if (AppDefs.user.results!!.phone != phone){
                    if (phone.startsWith("00")){
                        ...
                        Toast.makeText(washeeMainActivity, resources.getString(R.string.phone_number_format), Toast.LENGTH_SHORT).show()
                    }else{
                        checkPhone()
                    }
                }else{
    ...
    private fun saveUserToSharedPreferences() {
        ...
        editor.apply()
        val registrationIntent = Intent(washeeMainActivity, SplashActivity::class.java)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == Activity.RESULT_OK) {
            ...
            image = washeeMainActivity.convertToBase64(imageBitmap)!!
