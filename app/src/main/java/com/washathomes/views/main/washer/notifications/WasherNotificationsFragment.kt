...
import com.washathomes.databinding.FragmentWasherNotificationsBinding
...
@AndroidEntryPoint
class WasherNotificationsFragment : Fragment() {

    lateinit var binding: FragmentWasherNotificationsBinding
    ...
    private fun setNotificationsRV(){
        ...
        binding.notificationRecyclerview.layoutManager = LinearLayoutManager(washerMainActivity)
    }
