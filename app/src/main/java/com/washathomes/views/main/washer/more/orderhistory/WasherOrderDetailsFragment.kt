...
import com.washathomes.databinding.FragmentWasherOrderDetailsBinding
import dagger.hilt.android.AndroidEntryPoint
import java.util.*
@AndroidEntryPoint
class WasherOrderDetailsFragment : Fragment() {

    lateinit var binding: FragmentWasherOrderDetailsBinding
    ...
    override fun onCreateView(
        ...
        val layout = inflater.inflate(R.layout.fragment_washer_order_details, container, false)
        binding = FragmentWasherOrderDetailsBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun onClick(){
        ...
        binding.viewItemsLayout.setOnClickListener { navController.navigate(
            WasherOrderDetailsFragmentDirections.actionWasherOrderDetailsFragmentToWasherViewOrderItemsFragment()) }
    }
...
//            binding.paymentDiscountText.text = ""+washerMainActivity.formatter.format(discountValue)
//        }
//        val total = subTotal+taxValue-discountValue
//        binding.paymentCurrentTotalText.text = ""+washerMainActivity.formatter.format(total)
//    }
