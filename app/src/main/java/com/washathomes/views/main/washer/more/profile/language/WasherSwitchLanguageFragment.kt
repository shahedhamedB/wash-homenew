package com.washathomes.views.main.washer.more.profile.language
...
import com.washathomes.databinding.FragmentWasherSwitchLanguageBinding
...
@AndroidEntryPoint
class WasherSwitchLanguageFragment : Fragment() {

    lateinit var binding: FragmentWasherSwitchLanguageBinding
    ...
    override fun onCreateView(
        ...
        val layout = inflater.inflate(R.layout.fragment_washer_switch_language, container, false)
        binding = FragmentWasherSwitchLanguageBinding.inflate(layoutInflater)
        return binding.root
    }
        ...
        languagesCall.enqueue(object : Callback<UserData> {
            override fun onResponse(call: Call<UserData>, response: Response<UserData>) {
                if (response.isSuccessful){
                    ...
                    LocaleHelper.setAppLocale(lang, washerMainActivity)
    ...
    private fun saveUserToSharedPreferences() {
        ...
        editor.apply()
        val mainIntent = Intent(washerMainActivity, SplashActivity::class.java)
    ...
    private fun setSpinner() {
        val adapter = LanguagesAdapter(washerMainActivity, AppDefs.languages)
