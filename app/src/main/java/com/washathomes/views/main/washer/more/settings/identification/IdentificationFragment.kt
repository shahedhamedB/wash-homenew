package com.washathomes.views.main.washer.more.settings.identification
...
import com.washathomes.databinding.FragmentIdentificationBinding
...
class IdentificationFragment : Fragment() {
    ...
    private fun initViews(view: View){
        ...
        Glide.with(washerMainActivity).load(AppDefs.user.results!!.id_image).into(binding.washerUploadIdentificationImage)
    }
