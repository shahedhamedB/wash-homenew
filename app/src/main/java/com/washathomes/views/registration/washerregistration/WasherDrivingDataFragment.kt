...
import com.washathomes.databinding.FragmentWasherDrivingDataBinding
...
@AndroidEntryPoint
class WasherDrivingDataFragment : Fragment() {

    lateinit var binding: FragmentWasherDrivingDataBinding
    ...
    override fun onCreateView(
        ...
        val layout = inflater.inflate(R.layout.fragment_washer_driving_data, container, false)
        binding = FragmentWasherDrivingDataBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun onClick(){
        ...
        binding.car.setOnClickListener {
            ...
            Glide.with(washerRegistrationActivity).load(R.drawable.white_car).into(binding.carIcon)
            binding.bikeLayout.setBackgroundColor(resources.getColor(R.color.light_grey))
            Glide.with(washerRegistrationActivity).load(R.drawable.grey_bike).into(binding.bikeIcon)
            binding.bicycleLayout.setBackgroundColor(resources.getColor(R.color.light_grey))
            Glide.with(washerRegistrationActivity).load(R.drawable.grey_bicycle).into(binding.bicycleIcon)
            vehicleType = "1"
        ...
        binding.bike.setOnClickListener {
            ...
            Glide.with(washerRegistrationActivity).load(R.drawable.white_bike).into(binding.bikeIcon)
            binding.carLayout.setBackgroundColor(resources.getColor(R.color.light_grey))
            Glide.with(washerRegistrationActivity).load(R.drawable.grey_car).into(binding.carIcon)
            binding.bicycleLayout.setBackgroundColor(resources.getColor(R.color.light_grey))
            Glide.with(washerRegistrationActivity).load(R.drawable.grey_bicycle).into(binding.bicycleIcon)
            vehicleType = "2"
            binding.uploadVehicleID.isEnabled = true
        ...
        binding.bycicle.setOnClickListener {
            ...
            Glide.with(washerRegistrationActivity).load(R.drawable.white_bycicle).into(binding.bicycleIcon)
            binding.bikeLayout.setBackgroundColor(resources.getColor(R.color.light_grey))
            Glide.with(washerRegistrationActivity).load(R.drawable.grey_bike).into(binding.bikeIcon)
            binding.carLayout.setBackgroundColor(resources.getColor(R.color.light_grey))
            Glide.with(washerRegistrationActivity).load(R.drawable.grey_car).into(binding.carIcon)
    ...
    private fun updateUser(){
        ...
        updateDrivingDataCall.enqueue(object : Callback<UserData> {
            override fun onResponse(call: Call<UserData>, response: Response<UserData>) {
                ...
                navController.navigate(WasherDrivingDataFragmentDirections.actionWasherDrivingDataFragmentToWasherServicesDataFragment())
            }
