...
class IntroAdapter(contents: ArrayList<AccountTypeIntro>, washeeRegistrationActivity: WasheeRegistrationActivity) :
    PagerAdapter() {
    private val contents: ArrayList<AccountTypeIntro>
    private val washeeRegistrationActivity: WasheeRegistrationActivity
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        val inflater =
            washeeRegistrationActivity.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
    ...
    init {
        ...
        this.washeeRegistrationActivity = washeeRegistrationActivity
    }
