...
import com.washathomes.databinding.FragmentCourierIntroBinding
...
@AndroidEntryPoint
class CourierIntroFragment : Fragment() {

    lateinit var binding: FragmentCourierIntroBinding
    ...
    override fun onCreateView(
        ...
        val layout = inflater.inflate(R.layout.fragment_courier_intro, container, false)
        binding = FragmentCourierIntroBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun onClick(){
        binding.nextBtn.setOnClickListener { navController.navigate(CourierIntroFragmentDirections.actionCourierIntroFragmentToCourierSignUpFragment()) }
    }

    private fun getCourierIntro(){
        ...
        val washerIntroCall: Call<AccountTypeIntros> =
            retrofit.create(RetrofitAPIs::class.java).getCourierIntro()
