...
class IntroAdapter(contents: ArrayList<AccountTypeIntro>, courierRegistrationActivity: CourierRegistrationActivity) :
    PagerAdapter() {
    private val contents: ArrayList<AccountTypeIntro>
    private val courierRegistrationActivity: CourierRegistrationActivity
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        val inflater =
            courierRegistrationActivity.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
    ...
    init {
        ...
        this.courierRegistrationActivity = courierRegistrationActivity
    }
