...
data class CategoryItem(val id: String, val title: String, val image: String, val status: String, var favorite: String, var price: Double, val items_service: ArrayList<ItemService>, var quantity: Int = 0, var selectedServices: ArrayList<ItemService> = ArrayList(), var notes: String = "")
